package br.jus.tse.secad.taskexecutor.concurrent;
 ...
 * pool size 
 * (see {@link CustomizedThreadPoolExecutor#getPoolSize})
 * according to the bounds set by corePoolSize 
 * (see {@link CustomizedThreadPoolExecutor#getCorePoolSize})
 * and
 * maximumPoolSize
 * (see {@link CustomizedThreadPoolExecutor#getMaximumPoolSize}).
 * When a new task is submitted in method {@link
 * CustomizedThreadPoolExecutor#execute}, and fewer than corePoolSize threads
 ...
 * CustomizedThreadPoolExecutor#setCorePoolSize} and {@link
 * CustomizedThreadPoolExecutor#setMaximumPoolSize}. <dd>
 *
 ...
 * CustomizedThreadPoolExecutor#prestartCoreThread} or
 * {@link CustomizedThreadPoolExecutor#prestartAllCoreThreads}.  </dd>
 *
 ...
 * CustomizedThreadPoolExecutor#getKeepAliveTime}). This provides a means of
 * reducing resource consumption when the pool is not being actively
 * used. If the pool becomes more active later, new threads will be
 * constructed. This parameter can also be changed dynamically
 * using method {@link CustomizedThreadPoolExecutor#setKeepAliveTime}. Using
 ...
 * CustomizedThreadPoolExecutor#execute} will be <em>rejected</em> when the
 ...
 *
 * <li> In the
 * default {@link CustomizedThreadPoolExecutor.AbortPolicy}, the handler throws a
 * runtime {@link RejectedExecutionException} upon rejection. </li>
 * 
 * <li> In {@link
 * CustomizedThreadPoolExecutor.CallerRunsPolicy}, the thread that invokes
 ...
 *
 * <li> In {@link CustomizedThreadPoolExecutor.DiscardPolicy},
 * a task that cannot be executed is simply dropped.  </li>
 *
 * <li>In {@link
 * CustomizedThreadPoolExecutor.DiscardOldestPolicy}, if the executor is not
 ...
 * CustomizedThreadPoolExecutor#beforeExecute} and {@link
 * CustomizedThreadPoolExecutor#afterExecute} methods that are called before and
 ...
 * {@link CustomizedThreadPoolExecutor#terminated} can be overridden to perform
 ...
 *
 * <dd> Method {@link CustomizedThreadPoolExecutor#getQueue} allows access to
 ...
 * supplied methods, {@link CustomizedThreadPoolExecutor#remove} and {@link
 * CustomizedThreadPoolExecutor#purge} are available to assist in storage
...
public class CustomizedThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    Runnable getTask() throws InterruptedException {
        for (;;) {
            ...
            case RUNNING: {
                ...
                /*
                 * Aqui entra a diferença do original
                 */
                if (poolSize > corePoolSize) // é para diminuir o pool...
                    return null;
                
                /*
                 * É isso mesmo. Copiei toda a classe só para colocar esse conjunto de linhas.
                 */
     ...
     */
    public CustomizedThreadPoolExecutor(int corePoolSize,
                              int maximumPoolSize,
                              long keepAliveTime,
                              TimeUnit unit,
    ...
    public void execute(Runnable command) {
        ...
        for (;;) {
            ...
            if (workQueue.offer(command))
                return;
            if (poolSize >= maximumPoolSize){
            	//ALTERAÇÃO PARA NUNCA REJEITAR. FICA INFINITAMENTE EM LOOP.
                try {
					Thread.sleep(1000);
					continue;
     ...
     * However, in such cases, method {@link CustomizedThreadPoolExecutor#purge}
